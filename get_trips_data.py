...
with open('219005068_10min_7.csv', mode='w') as csv_file:
    ...
    for x in f2:
        ...
        if mmsi==str(default_mmsi):
            ...
            epoch1=datetime(int(datee[0]),int(datee[1]),int(datee[2]),int(start_time[0]),int(start_time[1]),int(start_time[2]))+(time_range*stage)
